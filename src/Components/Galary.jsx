...
const Galary = () => (
  <div>
    <div className="bg-[#f0f7fad7] mt-4   animate__animated animate__fadeInUp animate__slower animate__delay-3s">
      <div className=" flex flex-col justify-center items-center gap-3 py-6 sm:w-full md:w-11/12">
        <h1 className="text-2xl font-light mt-4   animate__animated animate__fadeInUp animate__slower animate__delay-4s">
          Memories we Saved
        </h1>
        <p className="text-center text-base sm:text-lg font-light sm:w-full md:w-9/12 mb-6   animate__animated animate__fadeInUp animate__slower animate__delay-5s">
          <span className="text-3xl text-blue-300   animate__animated animate__fadeInUp animate__slower animate__delay-6s">
            A
          </span>
          dventures are more than just journeys—they’re stories we carry with us
          forever. At Wild Explore, we’ve captured unforgettable moments filled
          with breathtaking mountain vistas, icy trails, and the joy of
